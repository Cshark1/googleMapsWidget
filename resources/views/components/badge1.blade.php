@props(['rating' => 0, 'reviews' => 0, 'dark' => true])

<div>
    <div class="border-dashed border-red-600 border-[1px] bg-gray-200 p-4 text-red-600">
        <div class="flex flex-row">
            ...
            <div class="flex flex-col">
                ...
                <div class="">
                    <p class="text-red-500 text-center text-xs">OUT OF <span class="font-extrabold">{{ $reviews }}</span> REVIEWS</p>
                </div>
